...
# 📌 Overview
This project showcases a Power BI analytics dashboard built using the Olist e‑commerce dataset. The goal is to analyze revenue performance, seller efficiency, customer behavior, and order dynamics across the Olist marketplace. It highlights end‑to‑end data skills including data cleaning, modeling, DAX, visualization, and business insight generation.

---

# 🎯 Objectives
* **Analyze revenue trends** across time, product categories, and customer segments.
* **Analyze revenue trends** across time, product categories, and customer segments.
* **Evaluate seller performance** using KPIs such as order volume, revenue contribution, delivery efficiency, and review scores.
* **Identify top sellers**, high‑value customers, and growth opportunities.
* **Provide insights** to support marketplace optimization and seller management.

---

# 🧩 Key Dashboard Features
* **KPI's:** Total revenue, Total Orders, Items Sold, Average Order Value, Late Delivery Rate and Cancellation Rate
* **Seller Performance:** Seller ranking, fulfillment metrics, delivery times, and customer review analysis.
* **Revenue-Driving Products:** Top product categories, revenue generation
* **Interactive Filters:** Explore insights by seller sales tier, evaluate individual sellers
...
10K-50K)" and Tier D(1,000 - 10K) sales range.* **Electronics and home goods** categories drive the highest overall revenue.
